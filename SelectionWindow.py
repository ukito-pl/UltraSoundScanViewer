...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_3.setText(_translate("Dialog", "Zmień parametry", None))
        self.pushButton.setText(_translate("Dialog", "Oblicz MAOP", None))
        self.pushButton_2.setText(_translate("Dialog", "Wykryj korozje", None))
